...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        coupon = [
            Coupon(coupon_code=get_random_string(5), coupon_type='C', discount=25.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='C', discount=30.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='C', discount=35.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='C', discount=40.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='C', discount=45.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='C', discount=50.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='C', discount=55.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='C', discount=60.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='C', discount=65.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='C', discount=70.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='C', discount=75.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='C', discount=80.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='C', discount=85.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='C', discount=90.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='C', discount=95.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='I', discount=5.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='I', discount=10.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='I', discount=15.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='I', discount=5.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='I', discount=10.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='I', discount=15.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='I', discount=5.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='I', discount=10.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='I', discount=15.00),
            Coupon(coupon_code=get_random_string(5), coupon_type='I', discount=20.00),
        ]
        ...
        payment = [
            Payment(card_name=User.objects.get(pk=6).first_name, card_zipcode=User.objects.get(pk=6).address_zipcode, payment_method='D', card_number='4444-5555-6666-7777', card_exp_date=datetime.strptime('2023-09-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=6)),
            Payment(card_name=User.objects.get(pk=7).first_name, card_zipcode=User.objects.get(pk=7).address_zipcode, payment_method='D', card_number='7777-8888-9999-0000', card_exp_date=datetime.strptime('2023-10-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=7)),
            Payment(card_name=User.objects.get(pk=8).first_name, card_zipcode=User.objects.get(pk=8).address_zipcode, payment_method='C', card_number='1234-5678-9012-3456', card_exp_date=datetime.strptime('2023-12-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=8)),
            Payment(card_name=User.objects.get(pk=9).first_name, card_zipcode=User.objects.get(pk=9).address_zipcode, payment_method='C', card_number='9876-5432-1098-7654', card_exp_date=datetime.strptime('2024-01-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=9)),
            Payment(card_name=User.objects.get(pk=10).first_name, card_zipcode=User.objects.get(pk=10).address_zipcode, payment_method='C', card_number='1111-2222-3333-4444', card_exp_date=datetime.strptime('2024-03-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=10)),
            Payment(card_name=User.objects.get(pk=27).first_name, card_zipcode=User.objects.get(pk=27).address_zipcode, payment_method='C', card_number='5555-6666-7777-8888', card_exp_date=datetime.strptime('2024-04-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=27)),
            Payment(card_name=User.objects.get(pk=30).first_name, card_zipcode=User.objects.get(pk=30).address_zipcode, payment_method='C', card_number='9999-0000-1111-2222', card_exp_date=datetime.strptime('2024-05-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=30)),
            Payment(card_name=User.objects.get(pk=31).first_name, card_zipcode=User.objects.get(pk=31).address_zipcode, payment_method='G', card_number='33335555', card_exp_date=datetime.strptime('2024-06-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=31)),
            Payment(card_name=User.objects.get(pk=34).first_name, card_zipcode=User.objects.get(pk=34).address_zipcode, payment_method='C', card_number='4444-5555-6666-7777', card_exp_date=datetime.strptime('2024-07-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=34)),
            Payment(card_name=User.objects.get(pk=35).first_name, card_zipcode=User.objects.get(pk=35).address_zipcode, payment_method='C', card_number='7777-8888-9999-0000', card_exp_date=datetime.strptime('2024-08-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=35)),
            Payment(card_name=User.objects.get(pk=1).first_name, card_zipcode=User.objects.get(pk=1).address_zipcode, payment_method='D', card_number='1234-5678-9012-3456', card_exp_date=datetime.strptime('2023-01-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=1)),
            Payment(card_name=User.objects.get(pk=7).first_name, card_zipcode=User.objects.get(pk=7).address_zipcode, payment_method='G', card_number='88882222', card_exp_date=datetime.strptime('2023-11-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=7)),
            Payment(card_name=User.objects.get(pk=2).first_name, card_zipcode=User.objects.get(pk=2).address_zipcode, payment_method='D', card_number='9876-5432-1098-7654', card_exp_date=datetime.strptime('2023-03-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=2)),
            Payment(card_name=User.objects.get(pk=2).first_name, card_zipcode=User.objects.get(pk=2).address_zipcode, payment_method='G', card_number='1222444', card_exp_date=datetime.strptime('2023-04-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=2)),
            Payment(card_name=User.objects.get(pk=2).first_name, card_zipcode=User.objects.get(pk=2).address_zipcode, payment_method='D', card_number='1111-2222-3333-4444', card_exp_date=datetime.strptime('2023-05-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=2)),
            Payment(card_name=User.objects.get(pk=3).first_name, card_zipcode=User.objects.get(pk=3).address_zipcode, payment_method='D', card_number='5555-6666-7777-8888', card_exp_date=datetime.strptime('2023-06-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=3)),
            Payment(card_name=User.objects.get(pk=4).first_name, card_zipcode=User.objects.get(pk=4).address_zipcode, payment_method='D', card_number='9999-0000-1111-2222', card_exp_date=datetime.strptime('2023-07-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=4)),
            Payment(card_name=User.objects.get(pk=5).first_name, card_zipcode=User.objects.get(pk=5).address_zipcode, payment_method='G', card_number='33335555', card_exp_date=datetime.strptime('2023-08-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=5)),
            Payment(card_name=User.objects.get(pk=10).first_name, card_zipcode=User.objects.get(pk=10).address_zipcode, payment_method='G', card_number='1222444', card_exp_date=datetime.strptime('2024-02-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=10)),
            Payment(card_name=User.objects.get(pk=11).first_name, card_zipcode=User.objects.get(pk=11).address_zipcode, payment_method='C', card_number='1111-2222-3333-4444', card_exp_date=datetime.strptime('2024-03-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=11)),
            Payment(card_name=User.objects.get(pk=12).first_name, card_zipcode=User.objects.get(pk=12).address_zipcode, payment_method='C', card_number='5555-6666-7777-8888', card_exp_date=datetime.strptime('2024-04-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=12)),
            Payment(card_name=User.objects.get(pk=13).first_name, card_zipcode=User.objects.get(pk=13).address_zipcode, payment_method='C', card_number='9999-0000-1111-2222', card_exp_date=datetime.strptime('2024-05-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=13)),
            Payment(card_name=User.objects.get(pk=14).first_name, card_zipcode=User.objects.get(pk=14).address_zipcode, payment_method='G', card_number='33335555', card_exp_date=datetime.strptime('2024-06-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=14)),
            Payment(card_name=User.objects.get(pk=15).first_name, card_zipcode=User.objects.get(pk=15).address_zipcode, payment_method='C', card_number='4444-5555-6666-7777', card_exp_date=datetime.strptime('2024-07-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=15)),
            Payment(card_name=User.objects.get(pk=16).first_name, card_zipcode=User.objects.get(pk=16).address_zipcode, payment_method='C', card_number='7777-8888-9999-0000', card_exp_date=datetime.strptime('2024-08-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=16)),
            Payment(card_name=User.objects.get(pk=17).first_name, card_zipcode=User.objects.get(pk=17).address_zipcode, payment_method='G', card_number='88882222', card_exp_date=datetime.strptime('2024-09-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=17)),
            Payment(card_name=User.objects.get(pk=18).first_name, card_zipcode=User.objects.get(pk=18).address_zipcode, payment_method='D', card_number='1234-5678-9012-3456', card_exp_date=datetime.strptime('2024-10-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=18)),
            Payment(card_name=User.objects.get(pk=19).first_name, card_zipcode=User.objects.get(pk=19).address_zipcode, payment_method='C', card_number='9876-5432-1098-7654', card_exp_date=datetime.strptime('2024-11-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=19)),
            Payment(card_name=User.objects.get(pk=20).first_name, card_zipcode=User.objects.get(pk=20).address_zipcode, payment_method='G', card_number='1222444', card_exp_date=datetime.strptime('2024-12-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=20)),
            Payment(card_name=User.objects.get(pk=20).first_name, card_zipcode=User.objects.get(pk=20).address_zipcode, payment_method='D', card_number='1111-2222-3333-4444', card_exp_date=datetime.strptime('2025-01-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=20)),
            Payment(card_name=User.objects.get(pk=17).first_name, card_zipcode=User.objects.get(pk=17).address_zipcode, payment_method='G', card_number='88882222', card_exp_date=datetime.strptime('2024-09-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=17)),
            Payment(card_name=User.objects.get(pk=18).first_name, card_zipcode=User.objects.get(pk=18).address_zipcode, payment_method='D', card_number='1234-5678-9012-3456', card_exp_date=datetime.strptime('2024-10-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=18)),
            Payment(card_name=User.objects.get(pk=19).first_name, card_zipcode=User.objects.get(pk=19).address_zipcode, payment_method='C', card_number='9876-5432-1098-7654', card_exp_date=datetime.strptime('2024-11-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=19)),
            Payment(card_name=User.objects.get(pk=20).first_name, card_zipcode=User.objects.get(pk=20).address_zipcode, payment_method='G', card_number='1222444', card_exp_date=datetime.strptime('2024-12-15', '%Y-%m-%d').date(), customer_id=User.objects.get(pk=20)),
